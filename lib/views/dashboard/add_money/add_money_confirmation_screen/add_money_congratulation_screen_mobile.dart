...
class AddMoneyCongratulationScreenMobile extends StatelessWidget {
  const AddMoneyCongratulationScreenMobile({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _addMoneyCongratulationTitleTextWidget(context),
            _addMoneyCongratulationSubTitleTextWidget(context),
  ...
  _addMoneyCongratulationTitleTextWidget(BuildContext context) {
  ...
  _addMoneyCongratulationSubTitleTextWidget(BuildContext context) {
    return TitleHeading4Widget(
      textAlign: TextAlign.center,
      text: Strings.addMoneyCongratulationSubtitle.tr,
      padding: EdgeInsets.only(
